...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7327859748:AAH9wUzPFJLKuT63DHV1aXQ-EVEKOeTQpog") # ⚠️ Required
    ...
    START_PIC = os.environ.get("START_PIC", "https://telegra.ph/file/3392347510ff67bb7eda2.jpg")
