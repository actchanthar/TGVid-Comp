...
📥 Fᴏʀ Hᴇʟᴘ Cᴏɴᴛ. @When_the_night_falls_my_soul_sea
"""
...
<b>⦿ Developer:</b> <a href=https://t.me/When_the_night_falls_my_soul_sea>act ❄️</a>
"""

    ABOUT_TXT = """<b>╭───────────⍟
├🤖 ᴍy ɴᴀᴍᴇ : @{}
├👨‍💻 Pʀᴏɢʀᴀᴍᴇʀ : <a href=https://t.me/When_the_night_falls_my_soul_sea>𝓢𝓝𝓞𝓦𝓑𝓐𝓛𝓛</a>
├📕 Lɪʙʀᴀʀy : <a href=https://github.com/pyrogram>Pyʀᴏɢʀᴀᴍ</a>
├✏️ Lᴀɴɢᴜᴀɢᴇ: <a href=https://www.python.org>Pyᴛʜᴏɴ 3</a>
├💾 Dᴀᴛᴀ Bᴀꜱᴇ: <a href=https://cloud.mongodb.com>Mᴏɴɢᴏ DB</a>
├🌀 ᴍʏ ꜱᴇʀᴠᴇʀ : <a href=https://www.ovhcloud.com>vps</a>
╰───────────────⍟ """
